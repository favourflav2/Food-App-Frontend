    ...
    <div className="flex w-full h-auto p-4">
      ...
      <div className="w-full h-full flex flex-col">
          ...
          <div className="sticky top-[85px] ">
            ...
            <div className=" flex flex-col w-full h-full">
              ...
              <div className="sticky top-[85px] flex items-center w-full h-[50px] ">
                <Button
                  variant="contained"
                  className="btnColor w-[90%] h-full rounded-3xl hover:bg-green-700"
                  onClick={() => setValue("pickup")}
                >
                  Pickup
                </Button>
                <Button
                  variant="contained"
                  disabled
                  className="btnColor w-[90%] h-full rounded-3xl"
                >
              ...
              <Modal open={open} onClose={handleClose} className="">
                <Box className="absolute translate-x-[-50%] translate-y-[-50%] top-[50%] left-[50%] sm:w-[480px] w-[95%] bg-white h-auto rounded-2xl">
                  ...
                  <Box className="flex flex-col w-full ">
                    ...
                    <Typography className="p-4 mt-[20px]">
                      Order Time
                    </Typography>
                ...
                <div className="flex flex-col w-full h-full border-[2px] border-gray-300 rounded-3xl p-4">
                  ...
                  <div className="flex flex-col w-full  overflow-auto">
                      ...
                      cart?.map(
                        (item: any, index: any) => (
                          <div className="flex  w-full py-4 border-b border-gray-300 cursor-pointer " key={index}>
                            {/* How much items */}
                            <h5 className="mr-3 text-[14.5px] font-semibold m-0 p-0">
                              {item?.count}
                            </h5>
                            ...
                            <div className="flex flex-col w-full ">
                              ...
                              <div className="flex items-center justify-between">
                                <h5 className="text-[14.5px] font-semibold hover:underline">
                                  {item?.type}
                                </h5>
                    ...
                    {expand === false &&
                      cart?.map(
                        (item: any, index: any) => (
                          <div className="flex w-full py-4 flex-col border-b border-gray-300 cursor-pointer group" onClick={() => dispatch(setHandleOpen(item))} key={index}>
                            <div className="flex items-center justify-between">
                              <div className="flex items-center mr-3">
                                <h5 className="mr-3 text-[14.5px]  font-semibold">
                                  {item?.count}
                                </h5>
                                <h5 className="text-[14.5px] font-semibold group-hover:underline">
                                  {item?.type}
                                </h5>
                              </div>
        ...
        <div className=" w-full h-full flex-col md:hidden flex">
          ...
          {cart?.length && <div className=" fixed bottom-0  rounded-3xl sm:w-[95%] w-[94%] flex justify-center items-center mb-5">
            <Button
                  ...
                  {cart?.map((item: any, index: any) => (
                    <div className="flex  w-full py-4 border-b border-gray-300 " key={index}>
                      ...
                      <div className="flex flex-col w-full ">
                        {/* food name */}
                        <div className="flex items-center justify-between">
                          <h5 className="text-[14.5px] font-semibold">
                            {item?.type}
                          </h5>
                          <h5 className="text-[14.5px] mr-2">${item.count * item.price.toFixed(2)}</h5>
                        </div>
